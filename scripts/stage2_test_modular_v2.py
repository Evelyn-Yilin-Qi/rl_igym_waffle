...
def main(checkpoint_path=None):
    ...
    env_setup = EnvironmentSetup(
        ...
        rng=rng,
        show_visual_walls=None,  # None让SceneManager自动决定：EMPTY场景不显示墙，其他场景显示
        reset_scene_obstacles=True  # Stage2需要重置障碍物位置
    )

...
def main():
    ...
    class TB3Task(RLTask):
        ...
        def set_up_scene(self, scene):
            ...
            # 显式应用 articulation 设置，提升求解稳定性
            # 注意：这一步在一些 OIGE 任务中是必要的，否则 USD/配置参数不会完整生效
            from omni.isaac.core.utils.prims import get_prim_at_path
            robot_prim = get_prim_at_path(self.default_zero_env_path + "/TB3")
            if robot_prim:
                try:
